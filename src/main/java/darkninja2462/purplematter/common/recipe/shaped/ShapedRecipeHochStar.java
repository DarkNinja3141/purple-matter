...
public class ShapedRecipeHochStar extends ShapedRecipeItemEMC {

    public ShapedRecipeHochStar(ShapedRecipeItemEMC recipe, BooleanSupplier enabledSupplier) {
        super(recipe, enabledSupplier);
    }

    public ShapedRecipeHochStar(ShapedRecipeItemEMC recipe) {
        super(recipe);
    }
    ...
    public static class Factory extends ShapedRecipeItemEMC.Factory {
        @Override
